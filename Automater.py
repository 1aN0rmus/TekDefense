...
'''
import httplib2, re
ipInput = '188.95.52.162'

#(raw_input('Please enter an IP address to be queried: '))
...
def main():
    ...
    rpd = re.compile('\s>(.{1,20})\<\/a>', re.IGNORECASE)
    ...
    print '#########################'
    print 'DNS Status'
    print 'This IP Address resolves to the following domains:'
    i=''
    for i in rpdSorted:
        if len(i)>4:
            if not i == ipInput:
